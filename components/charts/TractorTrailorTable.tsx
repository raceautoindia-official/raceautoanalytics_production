...
interface TractorTrailerProps {
  /** Overall-chart-data points; the historical "Trailer" series lives here. */
  overallData?: any[];
  /** Flash graph id mapped to Tractor-Trailer (per country) — drives forecast. */
  graphId?: number | null;
  ...
  return (
    ...
    >
      ...
      {!unlocked ? (
        ...
        // "Trailer" series + forecast lines driven by the mapped Flash graph.
