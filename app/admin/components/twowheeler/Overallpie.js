...
const TwoWheelerChartUploads = () => {
  ...
  const handleSubmit = () => uploadData(oemData, "/api/piechart");
  const evhandleSubmit = () => uploadData(evData, "/api/2w-ev");
  const apphandleSubmit = () => uploadData(appData, "/api/2w-app");
  ...
  return (
    <>
      ...
      <Section
        title="2-Wheeler Overall OEM Market Share Chart"
      ...
      />
      <Section
        title="2-Wheeler EV Electric Share Chart"
        fileName={evFileName}
        data={evData}
        onUpload={evhandleFileUpload}
        onSubmit={evhandleSubmit}
      />
      <Section
...
export default TwoWheelerChartUploads;
