...
function TruckChartUpload() {
  ...
  return (
    <>
      <Section
        title="Truck OverAll OEM Share"
        fileName={oemFileName}
        data={oemData}
        onUpload={handleFileUpload}
        onSubmit={() => uploadData(oemData, "/api/truck-overall")}
      />
      <Section
        title="Truck EV Electric Share"
        fileName={evFileName}
        data={evData}
        onUpload={evHandleFileUpload}
        onSubmit={() => uploadData(evData, "/api/truck-ev")}
      />
      <Section
        ...
        onSubmit={() => uploadData(appData, "/api/truck-app")}
      />
...
export default TruckChartUpload;
