...
function PassengerChartUpload() {
  ...
  return (
    <>
      ...
      <Section
        title="Passenger Vehicle OEM Market Share Chart"
        fileName={oemFileName}
        data={oemData}
        onUpload={handleFileUpload}
        onSubmit={() => uploadData(oemData, "/api/passenger-overall")}
      />
      <Section
        title="Passenger EV Electric Share Chart"
        fileName={evFileName}
        data={evData}
        onUpload={evHandleFileUpload}
        onSubmit={() => uploadData(evData, "/api/passenger-ev")}
      />
      <Section
        ...
        onSubmit={() => uploadData(appData, "/api/passenger-app")}
      />
    </>
  );
}

export default PassengerChartUpload;
