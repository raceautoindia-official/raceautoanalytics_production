...
function BusChartUpload() {
  ...
  return (
    <>
      <Section
        title="Bus Overall OEM Market Share"
        fileName={oemFileName}
        data={oemData}
        onUpload={handleFileUpload}
        onSubmit={() => uploadData(oemData, "/api/bus-overall")}
      />
      <Section
        title="Bus EV Electric Share"
        fileName={evFileName}
        data={evData}
        onUpload={evHandleFileUpload}
        onSubmit={() => uploadData(evData, "/api/bus-ev")}
      />
      <Section
        ...
        onSubmit={() => uploadData(appData, "/api/bus-app")}
      />
