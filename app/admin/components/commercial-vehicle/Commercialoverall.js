...
function CommercialChartUploads() {
  ...
  return (
    <>
      <Section
        title="CV Overall OEM Market Share Chart"
        fileName={oemFileName}
        data={oemData}
        onUpload={handleFileUpload}
        onSubmit={() => uploadData(oemData, "/api/commercial-overall")}
      />
...
export default CommercialChartUploads;
