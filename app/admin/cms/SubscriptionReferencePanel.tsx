...
export default function SubscriptionReferencePanel() {
  // Rendered inside the CMS, which is already gated by the /admin middleware
  // Basic-Auth — so this panel is always "authenticated" (no separate login).
